...
# Bloxflip auto mine by Aspect | discord.gg/deathsniper
...
class Game:
    ...
    def play_round(self):
        ...
        print(f"{Color(89, 39, 176)}STARTED{Color(255, 255, 255)} | Game started!")
...
def main():
    ...
    bet_amount = load_config["Bet_Amount"]
    mines_amount = load_config["Mines_Amount"]
    click_amount = load_config["Click_Amount"]
    stop_amount = load_config["Stop_Amount"]
    ...
    game = Game(auth_token, bet_amount, mines_amount, click_amount, stop_amount)
    game.start_game()
